...
import { NullAndEmptyHeadersCommand } from "../../commands/NullAndEmptyHeadersCommand";
 ...
 * Adds headers by prefix
 */
test.skip("RestJsonHttpPrefixHeadersArePresent:Response", async () => {
  const client = new RestJsonProtocolClient({
    requestHandler: new ResponseDeserializationTestHandler(
      true,
      200,
...
it("RestJsonHttpRequestWithLabelsAndTimestampFormat:Request", async () => {
  ...
  try {
    ...
    const r = err.request;
    expect(r.method).toBe("GET");
    expect(r.path).toBe("/HttpRequestWithLabelsAndTimestampFormat/1576540098/Mon%2C+16+Dec+2019+23%3A48%3A18+GMT/2019-12-16T23%3A48%3A18Z/2019-12-16T23%3A48%3A18Z/1576540098/Mon%2C+16+Dec+2019+23%3A48%3A18+GMT/2019-12-16T23%3A48%3A18Z");
 ...
 */
test.skip("RestJsonInputAndOutputWithTimestampHeaders:Response", async () => {
  const client = new RestJsonProtocolClient({
    requestHandler: new ResponseDeserializationTestHandler(
      true,
      200,
 ...
 * Serializes null values in lists
 */
test.skip("RestJsonListsSerializeNull:Response", async () => {
  const client = new RestJsonProtocolClient({
    requestHandler: new ResponseDeserializationTestHandler(
      true,
      200,
 ...
 */
test.skip("RestJsonNullAndEmptyHeaders:Request", async () => {
  const client = new RestJsonProtocolClient({
    requestHandler: new RequestSerializationTestHandler()
  });

  const command = new NullAndEmptyHeadersCommand(
    {
      a:
        undefined,
  ...
  try {
    ...
    const r = err.request;
    expect(r.method).toBe("GET");
    expect(r.path).toBe("/NullAndEmptyHeaders");
 ...
 */
test.skip("RestJsonNullAndEmptyHeaders:Response", async () => {
  const client = new RestJsonProtocolClient({
    requestHandler: new ResponseDeserializationTestHandler(
      true,
      200,
  ...
  const params: any = {};
  const command = new NullAndEmptyHeadersCommand(params);
