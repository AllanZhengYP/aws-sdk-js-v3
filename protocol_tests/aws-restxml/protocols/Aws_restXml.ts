...
export async function serializeAws_restXmlNullAndEmptyHeadersCommand(
...
export async function deserializeAws_restXmlNullAndEmptyHeadersCommand(
  output: __HttpResponse,
  context: __SerdeContext
): Promise<NullAndEmptyHeadersCommandOutput> {
  if (output.statusCode !== 200 && output.statusCode >= 400) {
    return deserializeAws_restXmlNullAndEmptyHeadersCommandError(output, context);
  }
...
async function deserializeAws_restXmlNullAndEmptyHeadersCommandError(
  output: __HttpResponse,
  context: __SerdeContext,
): Promise<NullAndEmptyHeadersCommandOutput> {
  const parsedOutput: any = {
