 ...
 * Adds headers by prefix
 */
test.skip("HttpPrefixHeadersArePresent:Response", async () => {
  const client = new RestXmlProtocolClient({
    requestHandler: new ResponseDeserializationTestHandler(
      true,
      200,
 ...
 */
test.skip("InputAndOutputWithTimestampHeaders:Response", async () => {
  const client = new RestXmlProtocolClient({
    requestHandler: new ResponseDeserializationTestHandler(
      true,
      200,
 ...
 */
test.skip("NullAndEmptyHeaders:Request", async () => {
  const client = new RestXmlProtocolClient({
    requestHandler: new RequestSerializationTestHandler()
  });
 ...
 */
test.skip("NullAndEmptyHeaders:Response", async () => {
  const client = new RestXmlProtocolClient({
    requestHandler: new ResponseDeserializationTestHandler(
      true,
      200,
