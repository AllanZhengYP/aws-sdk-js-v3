...
export class RestXmlProtocol extends RestXmlProtocolClient {
   ...
   */
  public nullAndEmptyHeaders(
    args: NullAndEmptyHeadersCommandInput,
    options?: __HttpHandlerOptions,
  ): Promise<NullAndEmptyHeadersCommandOutput>;
  public nullAndEmptyHeaders(
    args: NullAndEmptyHeadersCommandInput,
    cb: (err: any, data?: NullAndEmptyHeadersCommandOutput) => void
  ): void;
  public nullAndEmptyHeaders(
    args: NullAndEmptyHeadersCommandInput,
    options: __HttpHandlerOptions,
  ...
  public nullAndEmptyHeaders(
    args: NullAndEmptyHeadersCommandInput,
    optionsOrCb?: __HttpHandlerOptions | ((err: any, data?: NullAndEmptyHeadersCommandOutput) => void),
    cb?: (err: any, data?: NullAndEmptyHeadersCommandOutput) => void
  ): Promise<NullAndEmptyHeadersCommandOutput> | void {
    const command = new NullAndEmptyHeadersCommand(args);
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb)
    } else if (typeof cb === "function") {
      if (typeof optionsOrCb !== "object")
