...
export class DecreaseStreamRetentionPeriodCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<DecreaseStreamRetentionPeriodInput, DecreaseStreamRetentionPeriodOutput> {
        ...
        return stack.resolve(
            handler<DecreaseStreamRetentionPeriodInput, DecreaseStreamRetentionPeriodOutput>(handlerExecutionContext),
