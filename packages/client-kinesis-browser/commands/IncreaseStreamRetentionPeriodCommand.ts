...
> {
    ...
    ): __aws_sdk_types.Handler<IncreaseStreamRetentionPeriodInput, IncreaseStreamRetentionPeriodOutput> {
        const {handler} = configuration;
        const stack = clientStack.concat(this.middlewareStack);

        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext<IncreaseStreamRetentionPeriodInput, IncreaseStreamRetentionPeriodOutput, any> = {
            logger: {} as any,
            model: IncreaseStreamRetentionPeriod
        };

        return stack.resolve(
            handler<IncreaseStreamRetentionPeriodInput, IncreaseStreamRetentionPeriodOutput>(handlerExecutionContext),
