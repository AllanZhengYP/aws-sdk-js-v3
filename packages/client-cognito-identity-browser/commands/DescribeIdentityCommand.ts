...
export class DescribeIdentityCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext<DescribeIdentityInput, DescribeIdentityOutput, any> = {
            logger: {} as any,
