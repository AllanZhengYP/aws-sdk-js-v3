...
export interface RoboMakerResolvableConfiguration extends RoboMakerConfiguration {
    /**
...
export interface RoboMakerResolvedConfiguration extends RoboMakerConfiguration {
