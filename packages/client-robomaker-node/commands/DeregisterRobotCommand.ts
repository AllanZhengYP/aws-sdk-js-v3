...
export class DeregisterRobotCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: DeregisterRobot
        };

        return stack.resolve(
            handler<DeregisterRobotInput, DeregisterRobotOutput>(handlerExecutionContext),
