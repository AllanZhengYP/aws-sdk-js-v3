...
const md5Checksum: MiddlewareCustomizationDefinition = {
    ...
    expression:
`${packageNameToVariable('@aws-js-sdk-v3-prerelease/apply-body-checksum-middleware')}.applyBodyChecksumMiddleware(
    'Content-MD5',
    configuration.md5,
...
export function streamHasherProperty(
   streamType: string
    ...
    return {
        type: 'forked',
        inputType: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/types')}.StreamHasher<${streamType}>`,
        ...
        browser: {
            ...
            default: {
                type: 'value',
                expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/hash-blob-browser')}.calculateSha256`
            },
        },
        node: {
            required: false,
            ...
            default: {
                type: 'value',
                expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/hash-stream-node')}.calculateSha256`
            },
        },
        universal: {
            required: false,
...
const unsignedPayload: MiddlewareCustomizationDefinition = {
    ...
    expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/middleware-header-default')}.headerDefault({'x-amz-content-sha256': 'UNSIGNED-PAYLOAD'})`,
