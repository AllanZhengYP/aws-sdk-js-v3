    ...
    client: [
        {
            ...
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/add-glacier-checksum-headers-browser')}.addChecksumHeaders(
    this.config.sha256,
    ...
    client: [
        {
            ...
            type: 'Middleware',
            tags: `{ADD_CHECKSUM_HEADERS: true}`,
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/add-glacier-checksum-headers-universal')}.addChecksumHeaders(
    this.config.sha256,
    this.config.utf8Decoder
)`,
            configuration: {
    ...
    client: [
        {
            ...
            type: 'Middleware',
            tags: `{ADD_CHECKSUM_HEADERS: true}`,
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/add-glacier-checksum-headers-node')}.addChecksumHeaders(
    this.config.sha256,
    this.config.utf8Decoder
)`,
            configuration: {
...
const customizations: ServiceCustomizationDefinition = {
    ...
    INPUT_DEFAULT: true
            ...
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/middleware-input-default')}.inputDefault<InputTypesUnion>({
        accountId: '-'
    })`
        },
        {
            ...
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/middleware-sdk-glacier')}.addGlacierApiVersion`
        }
    ]
};
