...
export const base64Decoder: ConfigurationPropertyDefinition = {
    ...
    browser: {
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-base64-browser')}.fromBase64`,
        },
    },
    node: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-base64-node')}.fromBase64`,
        },
    },
    universal: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-base64-universal')}.fromBase64`,
        },
    },
};
...
export const base64Encoder: ConfigurationPropertyDefinition = {
    ...
    browser: {
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-base64-browser')}.toBase64`,
        },
    },
    node: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-base64-node')}.toBase64`,
        },
    },
    universal: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-base64-universal')}.toBase64`,
        },
    },
};
...
export const credentials: ConfigurationPropertyDefinition = {
    ...
    resolvedType: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/types')}.Provider<${credsType}>`,
    imports: [IMPORTS.types],
    ...
    node: {
        ...
        default: {
            type: 'provider',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/credential-provider-node')}.defaultProvider`
        },
        normalize: normalizeStaticOrProvider(
            credsType,
            "typeof value === 'object'"
...
export const md5: ConfigurationPropertyDefinition = {
    ...
    imports: [IMPORTS.types],
    documentation: 'A constructor for a class implementing the @aws-js-sdk-v3-prerelease/types.Hash interface that computes the MD5 checksum of a string or binary buffer',
    browser: {
        required: false,
        imports: [IMPORTS['md5-js']],
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/md5-js')}.Md5`,
        }
    },
    node: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/hash-node')}.Hash.bind(null, 'md5')`,
        }
    },
    universal: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/crypto-md5-universal')}.Md5`,
        }
    },
};
...
export const region: ConfigurationPropertyDefinition = {
    ...
    node: {
        ...
        default: {
            type: 'provider',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/region-provider')}.defaultProvider`
        },
...
export const sha256: ConfigurationPropertyDefinition = {
    ...
    imports: [IMPORTS.types],
    documentation: 'A constructor for a class implementing the @aws-js-sdk-v3-prerelease/types.Hash interface that computes the SHA-256 HMAC or checksum of a string or binary buffer',
    browser: {
        required: false,
        imports: [IMPORTS['crypto-sha256-browser']],
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/crypto-sha256-browser')}.Sha256`,
        }
    },
    node: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/hash-node')}.Hash.bind(null, 'sha256')`,
        }
    },
    universal: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/crypto-sha256-universal')}.Sha256`,
        }
    },
};
...
export const utf8Decoder: ConfigurationPropertyDefinition = {
    ...
    browser: {
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-utf8-browser')}.fromUtf8`,
        },
    },
    node: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-utf8-node')}.fromUtf8`,
        },
    },
    universal: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-utf8-universal')}.fromUtf8`,
        },
    },
};
...
export const urlParser: ConfigurationPropertyDefinition = {
    ...
    browser: {
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/url-parser-browser')}.parseUrl`,
        },
    },
    node: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/url-parser-node')}.parseUrl`,
        },
    },
    universal: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/url-parser-universal')}.parseUrl`,
        },
    },
};
...
export const utf8Encoder: ConfigurationPropertyDefinition = {
    ...
    browser: {
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-utf8-browser')}.toUtf8`,
        },
    },
    node: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-utf8-node')}.toUtf8`,
        },
    },
    universal: {
        required: false,
        ...
        default: {
            type: 'value',
            expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-utf8-universal')}.toUtf8`,
        },
    },
};
