...
export const setContentLengthConfiguration: MiddlewareCustomizationDefinition = {
    ...
    expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/middleware-content-length')}.contentLengthMiddleware(
    ...
    configuration: {
        bodyLengthChecker: {
            ...
            browser: {
                ...
                default: {
                    type: 'value',
                    expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-body-length-browser')}.calculateBodyLength`
                }
            },
            node: {
                required: false,
                ...
                default: {
                    type: 'value',
                    expression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/util-body-length-node')}.calculateBodyLength`
                }
            },
            universal: {
                required: false,
