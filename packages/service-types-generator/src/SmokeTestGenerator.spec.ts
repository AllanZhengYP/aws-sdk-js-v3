...
import {SmokeTestModel} from '@aws-js-sdk-v3-prerelease/build-types';
    ...
    describe('browser', () => {
        it('generates a test/smoke/index.spec.ts and karma.conf file', () => {
            const generator = new SmokeTestGenerator({
                clientName: 'Foo',
                model: mockModel,
                packageName: '@aws-js-sdk-v3-prerelease/client-foo-browser',
                runtime: 'browser',
                serviceModel
            });
    ...
    describe('node', () => {
        ...
        it('generates a test/smoke/index.spec.ts file', () => {
            const generator = new SmokeTestGenerator({
                clientName: 'Foo',
                model: mockModel,
                packageName: '@aws-js-sdk-v3-prerelease/client-foo-node',
                runtime: 'node',
                serviceModel
            });
