    ...
    */
    ...
    get devDependencies() {
        ...
        if (this.runtime === 'browser') {
            dependencies['@aws-js-sdk-v3-prerelease/karma-credential-loader'] = '^0.1.0';
...
smokeTestRunner();
    ...
    private generateBrowserSmokeTestFile() {
        ...
        // These variables are injected by the @aws-js-sdk-v3-prerelease/karma-credentials-plugin
