...
import {Import, ConfigurationDefinition, RuntimeTarget} from '@aws-js-sdk-v3-prerelease/build-types';
...
export const configurationProperties: ${packageNameToVariable('@aws-js-sdk-v3-prerelease/types')}.ConfigurationDefinition<
