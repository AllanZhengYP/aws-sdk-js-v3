...
describe('Command', () => {
    ...
    it('should include a command class', () => {
        ...
        expect(sender.toString()).toMatch(
            'export class GetResourceCommand implements __aws_js_sdk_v3_prerelease_types.Command<'
        );
    });
    ...
    describe('middleware resolution', () => {
        const mockFooMiddlewareDefinition: MiddlewareCustomizationDefinition = {
            ...
            type: 'Middleware',
            priority: 10,
            expression: '__aws_js_sdk_v3_prerelease_foo.fooMiddleware'
        };
        const mockBarMiddlewareDefinition: MiddlewareCustomizationDefinition = {
            ...
            type: 'Middleware',
            priority: 20,
            expression: '__aws_js_sdk_v3_prerelease_bar.barMiddleware'
        };
        ...
        it('should include defined middleware', () => {
            ...
            expect(commandCode).toMatch(`import * as __aws_js_sdk_v3_prerelease_foo from '@aws-js-sdk-v3-prerelease/foo';`);
            [
                'stack.add(',
        ...
        it('should handle multiple middleware', () => {
            ...
            const commandCode = sender.toString();
            expect(commandCode).toMatch(`import * as __aws_js_sdk_v3_prerelease_foo from '@aws-js-sdk-v3-prerelease/foo';`);
            expect(commandCode).toMatch(`import * as __aws_js_sdk_v3_prerelease_bar from '@aws-js-sdk-v3-prerelease/bar';`);
            expect(commandCode).toMatch(`import * as __aws_js_sdk_v3_prerelease_bar_middleware from '@aws-js-sdk-v3-prerelease/bar-middleware';`);
            [
                'stack.add(',
                `${mockFooMiddlewareDefinition.expression}`,
                `step: '${mockFooMiddlewareDefinition.step}`,
