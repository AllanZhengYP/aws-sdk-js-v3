...
export const OUTPUT_METADATA_PROPERTY: SyntheticParameterCustomizationDefinition = {
    ...
    location: 'output',
    typeExpression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/types')}.ResponseMetadata`,
...
export const INPUT_SIGNAL_PROPERTY: SyntheticParameterCustomizationDefinition = {
    type: 'SyntheticParameter',
    location: 'input',
    typeExpression: `${packageNameToVariable('@aws-js-sdk-v3-prerelease/types')}.AbortSignal`,
    documentation:
