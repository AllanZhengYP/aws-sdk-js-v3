...
export interface _TooManyRequestsExceptionDetails {
     ...
     */
    Reason?: 'ConcurrentInvocationLimitExceeded'|'FunctionInvocationRateLimitExceeded'|'ReservedFunctionConcurrentInvocationLimitExceeded'|'ReservedFunctionInvocationRateLimitExceeded'|'CallerRateLimitExceeded'|string;
}