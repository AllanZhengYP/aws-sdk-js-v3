...
export class CreateEventSourceMappingCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<CreateEventSourceMappingInput, CreateEventSourceMappingOutput> {
        ...
        return stack.resolve(
            handler<CreateEventSourceMappingInput, CreateEventSourceMappingOutput>(handlerExecutionContext),
