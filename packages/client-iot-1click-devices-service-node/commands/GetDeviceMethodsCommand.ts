...
export class GetDeviceMethodsCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: GetDeviceMethods
        };

        return stack.resolve(
            handler<GetDeviceMethodsInput, GetDeviceMethodsOutput>(handlerExecutionContext),
