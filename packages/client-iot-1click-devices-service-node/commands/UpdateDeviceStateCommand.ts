...
export class UpdateDeviceStateCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        return stack.resolve(
            handler<UpdateDeviceStateInput, UpdateDeviceStateOutput>(handlerExecutionContext),
