...
import {IoT1ClickDevicesServiceConfiguration, IoT1ClickDevicesServiceResolvedConfiguration, configurationProperties} from './IoT1ClickDevicesServiceConfiguration';
import {InputTypesUnion} from './types/InputTypesUnion';
import {OutputTypesUnion} from './types/OutputTypesUnion';
import {clientVersion, ServiceMetadata} from './model/ServiceMetadata';

export class IoT1ClickDevicesServiceClient {
    protected readonly config: IoT1ClickDevicesServiceResolvedConfiguration;
    ...
    constructor(configuration: IoT1ClickDevicesServiceConfiguration) {
    ...
    >(command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, IoT1ClickDevicesServiceResolvedConfiguration, _stream.Readable>): Promise<OutputType>;
    send<
        InputType extends InputTypesUnion,
        OutputType extends OutputTypesUnion
    >(
        command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, IoT1ClickDevicesServiceResolvedConfiguration, _stream.Readable>,
