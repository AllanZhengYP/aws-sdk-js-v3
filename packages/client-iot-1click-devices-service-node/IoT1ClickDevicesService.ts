...
export class IoT1ClickDevicesService extends IoT1ClickDevicesServiceClient {
     ...
     */
    public claimDevicesByClaimCode(args: ClaimDevicesByClaimCodeInput): Promise<ClaimDevicesByClaimCodeOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public describeDevice(args: DescribeDeviceInput): Promise<DescribeDeviceOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public finalizeDeviceClaim(args: FinalizeDeviceClaimInput): Promise<FinalizeDeviceClaimOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public getDeviceMethods(args: GetDeviceMethodsInput): Promise<GetDeviceMethodsOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public initiateDeviceClaim(args: InitiateDeviceClaimInput): Promise<InitiateDeviceClaimOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public invokeDeviceMethod(args: InvokeDeviceMethodInput): Promise<InvokeDeviceMethodOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public listDeviceEvents(args: ListDeviceEventsInput): Promise<ListDeviceEventsOutput>;
    ...
    /**
     * <p>List all tags on an AWS IoT 1-Click resource.</p>
     *
     * This operation may fail with one of the following errors:
     *   - {ResourceNotFoundException} ResourceNotFoundException shape
     *   - {InternalFailureException} InternalFailureException shape
    ...
    /**
     * <p>Associate a set of tags with an AWS IoT 1-Click resource. You can then activate these user-defined tags so that they appear on the Billing and Cost Management console for cost allocation tracking.</p>
     *
     * This operation may fail with one of the following errors:
     *   - {ResourceNotFoundException} ResourceNotFoundException shape
     *   - {InvalidRequestException} InvalidRequestException shape
    ...
    /**
     * <p>Removes the association of tags from an AWS IoT 1-Click resource.</p>
     *
     * This operation may fail with one of the following errors:
     *   - {ResourceNotFoundException} ResourceNotFoundException shape
     *   - {InvalidRequestException} InvalidRequestException shape
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public updateDeviceState(args: UpdateDeviceStateInput): Promise<UpdateDeviceStateOutput>;
