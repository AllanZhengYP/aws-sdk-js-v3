import {_Connection, _UnmarshalledConnection} from './_Connection';

/**
 * <p>Information about a link aggregation group (LAG).</p>
 */
export interface _Lag {
    /**
     ...
     */
    lagState?: 'requested'|'pending'|'available'|'down'|'deleting'|'deleted'|'unknown'|string;
     ...
     */
    connections?: Array<_Connection>|Iterable<_Connection>;
...
export interface _UnmarshalledLag extends _Lag {
    /**
     * <p>The connections bundled by the LAG.</p>
     */
