...
export class DeleteDirectConnectGatewayAssociationCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<DeleteDirectConnectGatewayAssociationInput, DeleteDirectConnectGatewayAssociationOutput> {
        const {handler} = configuration;
        const stack = clientStack.concat(this.middlewareStack);

        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: DeleteDirectConnectGatewayAssociation
        };

        return stack.resolve(
            handler<DeleteDirectConnectGatewayAssociationInput, DeleteDirectConnectGatewayAssociationOutput>(handlerExecutionContext),
