...
export class UpdateJobTemplateCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: UpdateJobTemplate
        };

        return stack.resolve(
            handler<UpdateJobTemplateInput, UpdateJobTemplateOutput>(handlerExecutionContext),
