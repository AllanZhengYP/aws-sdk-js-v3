...
import {_MsSmoothEncryptionSettings, _UnmarshalledMsSmoothEncryptionSettings} from './_MsSmoothEncryptionSettings';
...
export interface _UnmarshalledMsSmoothGroupSettings extends _MsSmoothGroupSettings {
    /**
     * Settings associated with the destination. Will vary based on the type of destination
     */
