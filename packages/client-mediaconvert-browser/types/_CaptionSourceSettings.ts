import {_AncillarySourceSettings, _UnmarshalledAncillarySourceSettings} from './_AncillarySourceSettings';
import {_DvbSubSourceSettings, _UnmarshalledDvbSubSourceSettings} from './_DvbSubSourceSettings';
import {_EmbeddedSourceSettings, _UnmarshalledEmbeddedSourceSettings} from './_EmbeddedSourceSettings';
import {_FileSourceSettings, _UnmarshalledFileSourceSettings} from './_FileSourceSettings';
import {_TeletextSourceSettings, _UnmarshalledTeletextSourceSettings} from './_TeletextSourceSettings';
import {_TrackSourceSettings, _UnmarshalledTrackSourceSettings} from './_TrackSourceSettings';
...
export interface _CaptionSourceSettings {
     ...
     */
    SourceType?: 'ANCILLARY'|'DVB_SUB'|'EMBEDDED'|'SCTE20'|'SCC'|'TTML'|'STL'|'SRT'|'SMI'|'TELETEXT'|'NULL_SOURCE'|'IMSC'|string;
...
export interface _UnmarshalledCaptionSourceSettings extends _CaptionSourceSettings {
    /**
     * Settings for ancillary captions source.
     */
