import {_AudioSelectorGroup, _UnmarshalledAudioSelectorGroup} from './_AudioSelectorGroup';
import {_AudioSelector, _UnmarshalledAudioSelector} from './_AudioSelector';
import {_CaptionSelector, _UnmarshalledCaptionSelector} from './_CaptionSelector';
import {_InputDecryptionSettings, _UnmarshalledInputDecryptionSettings} from './_InputDecryptionSettings';
...
export interface _Input {
     ...
     */
    AudioSelectorGroups?: {[key: string]: _AudioSelectorGroup}|Iterable<[string, _AudioSelectorGroup]>;
     ...
     */
    AudioSelectors?: {[key: string]: _AudioSelector}|Iterable<[string, _AudioSelector]>;
     ...
     */
    CaptionSelectors?: {[key: string]: _CaptionSelector}|Iterable<[string, _CaptionSelector]>;
