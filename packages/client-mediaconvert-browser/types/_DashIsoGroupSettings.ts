...
import {_DashIsoEncryptionSettings, _UnmarshalledDashIsoEncryptionSettings} from './_DashIsoEncryptionSettings';
...
export interface _UnmarshalledDashIsoGroupSettings extends _DashIsoGroupSettings {
    /**
     * Settings associated with the destination. Will vary based on the type of destination
     */
