import {_AccelerationSettings, _UnmarshalledAccelerationSettings} from './_AccelerationSettings';
import {_OutputGroupDetail, _UnmarshalledOutputGroupDetail} from './_OutputGroupDetail';
...
export interface _Job {
     ...
     */
    Status?: 'SUBMITTED'|'PROGRESSING'|'COMPLETE'|'CANCELED'|'ERROR'|string;
