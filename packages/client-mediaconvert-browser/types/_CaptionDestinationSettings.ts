import {_BurninDestinationSettings, _UnmarshalledBurninDestinationSettings} from './_BurninDestinationSettings';
import {_DvbSubDestinationSettings, _UnmarshalledDvbSubDestinationSettings} from './_DvbSubDestinationSettings';
import {_EmbeddedDestinationSettings, _UnmarshalledEmbeddedDestinationSettings} from './_EmbeddedDestinationSettings';
import {_SccDestinationSettings, _UnmarshalledSccDestinationSettings} from './_SccDestinationSettings';
import {_TeletextDestinationSettings, _UnmarshalledTeletextDestinationSettings} from './_TeletextDestinationSettings';
import {_TtmlDestinationSettings, _UnmarshalledTtmlDestinationSettings} from './_TtmlDestinationSettings';
...
export interface _CaptionDestinationSettings {
     ...
     */
    DestinationType?: 'BURN_IN'|'DVB_SUB'|'EMBEDDED'|'EMBEDDED_PLUS_SCTE20'|'SCTE20_PLUS_EMBEDDED'|'SCC'|'SRT'|'SMI'|'TELETEXT'|'TTML'|'WEBVTT'|string;
...
export interface _UnmarshalledCaptionDestinationSettings extends _CaptionDestinationSettings {
    /**
     * Burn-In Destination Settings.
     */
