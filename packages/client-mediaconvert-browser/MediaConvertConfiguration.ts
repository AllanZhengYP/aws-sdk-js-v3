...
export interface MediaConvertResolvableConfiguration extends MediaConvertConfiguration {
    /**
...
export interface MediaConvertResolvedConfiguration extends MediaConvertConfiguration {
