...
```javascript
//javascript
const { DirectConnectClient } = require('@aws-sdk/client-direct-connect-node/DirectConnectClient');
const { AcceptDirectConnectGatewayAssociationProposalCommand } = require('@aws-sdk/client-direct-connect-node/commands/AcceptDirectConnectGatewayAssociationProposalCommand');
```
