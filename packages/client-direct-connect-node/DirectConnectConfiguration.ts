...
export interface DirectConnectResolvableConfiguration extends DirectConnectConfiguration {
    /**
...
export interface DirectConnectResolvedConfiguration extends DirectConnectConfiguration {
