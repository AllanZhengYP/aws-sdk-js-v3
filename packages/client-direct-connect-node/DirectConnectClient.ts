...
import {DirectConnectConfiguration, DirectConnectResolvedConfiguration, configurationProperties} from './DirectConnectConfiguration';
import {InputTypesUnion} from './types/InputTypesUnion';
import {OutputTypesUnion} from './types/OutputTypesUnion';
import {clientVersion, ServiceMetadata} from './model/ServiceMetadata';

export class DirectConnectClient {
    protected readonly config: DirectConnectResolvedConfiguration;
    ...
    >(command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, DirectConnectResolvedConfiguration, _stream.Readable>): Promise<OutputType>;
    send<
        InputType extends InputTypesUnion,
        OutputType extends OutputTypesUnion
    >(
        command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, DirectConnectResolvedConfiguration, _stream.Readable>,
