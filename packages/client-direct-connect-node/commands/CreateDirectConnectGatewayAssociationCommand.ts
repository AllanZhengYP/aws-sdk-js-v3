...
export class CreateDirectConnectGatewayAssociationCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<CreateDirectConnectGatewayAssociationInput, CreateDirectConnectGatewayAssociationOutput> {
        const {handler} = configuration;
        const stack = clientStack.concat(this.middlewareStack);

        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: CreateDirectConnectGatewayAssociation
        };

        return stack.resolve(
            handler<CreateDirectConnectGatewayAssociationInput, CreateDirectConnectGatewayAssociationOutput>(handlerExecutionContext),
