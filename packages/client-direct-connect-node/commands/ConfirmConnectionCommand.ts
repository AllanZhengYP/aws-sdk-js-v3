...
export class ConfirmConnectionCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: ConfirmConnection
        };

        return stack.resolve(
            handler<ConfirmConnectionInput, ConfirmConnectionOutput>(handlerExecutionContext),
