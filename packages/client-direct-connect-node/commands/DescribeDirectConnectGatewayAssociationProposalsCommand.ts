...
export class DescribeDirectConnectGatewayAssociationProposalsCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    constructor(readonly input: DescribeDirectConnectGatewayAssociationProposalsInput) {}

    resolveMiddleware(
        clientStack: __aws_sdk_middleware_stack.MiddlewareStack<InputTypesUnion, OutputTypesUnion, _stream.Readable>,
        configuration: DirectConnectResolvedConfiguration
    ): __aws_sdk_types.Handler<DescribeDirectConnectGatewayAssociationProposalsInput, DescribeDirectConnectGatewayAssociationProposalsOutput> {
        const {handler} = configuration;
        const stack = clientStack.concat(this.middlewareStack);

        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: DescribeDirectConnectGatewayAssociationProposals
        };

        return stack.resolve(
            handler<DescribeDirectConnectGatewayAssociationProposalsInput, DescribeDirectConnectGatewayAssociationProposalsOutput>(handlerExecutionContext),
