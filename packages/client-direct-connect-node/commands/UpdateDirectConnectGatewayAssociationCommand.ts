...
import {UpdateDirectConnectGatewayAssociation} from '../model/UpdateDirectConnectGatewayAssociation';
...
export class UpdateDirectConnectGatewayAssociationCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<UpdateDirectConnectGatewayAssociationInput, UpdateDirectConnectGatewayAssociationOutput> {
        const {handler} = configuration;
        const stack = clientStack.concat(this.middlewareStack);

        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: UpdateDirectConnectGatewayAssociation
        };

        return stack.resolve(
            handler<UpdateDirectConnectGatewayAssociationInput, UpdateDirectConnectGatewayAssociationOutput>(handlerExecutionContext),
