...
export class CreateDatastoreCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: CreateDatastore
        };

        return stack.resolve(
            handler<CreateDatastoreInput, CreateDatastoreOutput>(handlerExecutionContext),
