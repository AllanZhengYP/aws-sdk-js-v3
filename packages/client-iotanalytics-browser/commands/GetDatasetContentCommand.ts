...
export class GetDatasetContentCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: GetDatasetContent
        };

        return stack.resolve(
            handler<GetDatasetContentInput, GetDatasetContentOutput>(handlerExecutionContext),
