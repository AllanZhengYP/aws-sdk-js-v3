...
export class BatchPutMessageCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: BatchPutMessage
        };

        return stack.resolve(
            handler<BatchPutMessageInput, BatchPutMessageOutput>(handlerExecutionContext),
