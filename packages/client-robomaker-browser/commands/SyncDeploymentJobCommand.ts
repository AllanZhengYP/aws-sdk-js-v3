...
export class SyncDeploymentJobCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: SyncDeploymentJob
        };

        return stack.resolve(
            handler<SyncDeploymentJobInput, SyncDeploymentJobOutput>(handlerExecutionContext),
