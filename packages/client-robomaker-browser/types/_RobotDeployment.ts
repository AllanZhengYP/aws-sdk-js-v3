import {_ProgressDetail, _UnmarshalledProgressDetail} from './_ProgressDetail';
...
export interface _RobotDeployment {
     ...
     */
    status?: 'Available'|'Registered'|'PendingNewDeployment'|'Deploying'|'Failed'|'InSync'|'NoResponse'|string;
