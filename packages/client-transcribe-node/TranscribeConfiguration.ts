...
export interface TranscribeResolvableConfiguration extends TranscribeConfiguration {
    /**
...
export interface TranscribeResolvedConfiguration extends TranscribeConfiguration {
