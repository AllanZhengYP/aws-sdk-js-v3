...
export class ListVocabulariesCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: ListVocabularies
        };

        return stack.resolve(
            handler<ListVocabulariesInput, ListVocabulariesOutput>(handlerExecutionContext),
