...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<GetSamplingTargetsInput, GetSamplingTargetsOutput> {
        ...
        return stack.resolve(
            handler<GetSamplingTargetsInput, GetSamplingTargetsOutput>(handlerExecutionContext),
