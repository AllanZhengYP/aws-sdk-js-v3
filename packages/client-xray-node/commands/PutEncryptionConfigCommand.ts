...
export class PutEncryptionConfigCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<PutEncryptionConfigInput, PutEncryptionConfigOutput> {
        ...
        return stack.resolve(
            handler<PutEncryptionConfigInput, PutEncryptionConfigOutput>(handlerExecutionContext),
