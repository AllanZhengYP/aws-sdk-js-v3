...
type HttpRequestOptions<StreamType> = Partial<HttpMessage<StreamType>> &
  Partial<HttpEndpoint> & { method?: string };

export class HttpRequest<StreamType>
  implements HttpMessage<StreamType>, HttpEndpoint {
  ...
  constructor(options: HttpRequestOptions<StreamType>) {
