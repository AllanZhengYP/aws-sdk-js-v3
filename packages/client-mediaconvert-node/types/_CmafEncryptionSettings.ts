import {_StaticKeyProvider, _UnmarshalledStaticKeyProvider} from './_StaticKeyProvider';
...
export interface _UnmarshalledCmafEncryptionSettings extends _CmafEncryptionSettings {
    /**
     * Use these settings to set up encryption with a static key provider.
     */
