import {_NoiseReducerFilterSettings, _UnmarshalledNoiseReducerFilterSettings} from './_NoiseReducerFilterSettings';
import {_NoiseReducerSpatialFilterSettings, _UnmarshalledNoiseReducerSpatialFilterSettings} from './_NoiseReducerSpatialFilterSettings';
...
export interface _NoiseReducer {
     ...
     */
    Filter?: 'BILATERAL'|'MEAN'|'GAUSSIAN'|'LANCZOS'|'SHARPEN'|'CONSERVE'|'SPATIAL'|string;
