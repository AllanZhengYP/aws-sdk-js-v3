import {_CmafGroupSettings, _UnmarshalledCmafGroupSettings} from './_CmafGroupSettings';
import {_DashIsoGroupSettings, _UnmarshalledDashIsoGroupSettings} from './_DashIsoGroupSettings';
import {_FileGroupSettings, _UnmarshalledFileGroupSettings} from './_FileGroupSettings';
import {_HlsGroupSettings, _UnmarshalledHlsGroupSettings} from './_HlsGroupSettings';
import {_MsSmoothGroupSettings, _UnmarshalledMsSmoothGroupSettings} from './_MsSmoothGroupSettings';
...
export interface _OutputGroupSettings {
     ...
     */
    Type?: 'HLS_GROUP_SETTINGS'|'DASH_ISO_GROUP_SETTINGS'|'FILE_GROUP_SETTINGS'|'MS_SMOOTH_GROUP_SETTINGS'|'CMAF_GROUP_SETTINGS'|string;
}
