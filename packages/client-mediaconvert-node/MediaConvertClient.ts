...
import {MediaConvertConfiguration, MediaConvertResolvedConfiguration, configurationProperties} from './MediaConvertConfiguration';
import {InputTypesUnion} from './types/InputTypesUnion';
import {OutputTypesUnion} from './types/OutputTypesUnion';
import {clientVersion, ServiceMetadata} from './model/ServiceMetadata';

export class MediaConvertClient {
    protected readonly config: MediaConvertResolvedConfiguration;
    ...
    >(command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, MediaConvertResolvedConfiguration, _stream.Readable>): Promise<OutputType>;
    send<
        InputType extends InputTypesUnion,
        OutputType extends OutputTypesUnion
    >(
        command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, MediaConvertResolvedConfiguration, _stream.Readable>,
