...
export class DeleteJobTemplateCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: DeleteJobTemplate
        };

        return stack.resolve(
            handler<DeleteJobTemplateInput, DeleteJobTemplateOutput>(handlerExecutionContext),
