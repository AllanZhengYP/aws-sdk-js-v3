...
export class CreateJobTemplateCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: CreateJobTemplate
        };

        return stack.resolve(
            handler<CreateJobTemplateInput, CreateJobTemplateOutput>(handlerExecutionContext),
