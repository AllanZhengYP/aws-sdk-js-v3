...
export class ListJobTemplatesCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: ListJobTemplates
        };

        return stack.resolve(
            handler<ListJobTemplatesInput, ListJobTemplatesOutput>(handlerExecutionContext),
