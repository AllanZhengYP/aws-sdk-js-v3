...
export class GetJobTemplateCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
    GetJobTemplateInput,
    OutputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: GetJobTemplate
        };

        return stack.resolve(
            handler<GetJobTemplateInput, GetJobTemplateOutput>(handlerExecutionContext),
