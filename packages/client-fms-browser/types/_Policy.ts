import {_SecurityServicePolicyData, _UnmarshalledSecurityServicePolicyData} from './_SecurityServicePolicyData';
...
export interface _Policy {
     ...
     */
    IncludeMap?: {[key in 'ACCOUNT'|string]: Array<string>|Iterable<string>}|Iterable<['ACCOUNT'|string, Array<string>|Iterable<string>]>;
     ...
     */
    ExcludeMap?: {[key in 'ACCOUNT'|string]: Array<string>|Iterable<string>}|Iterable<['ACCOUNT'|string, Array<string>|Iterable<string>]>;
}
