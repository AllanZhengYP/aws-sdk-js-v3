...
export interface IoTAnalyticsResolvableConfiguration extends IoTAnalyticsConfiguration {
    /**
...
export interface IoTAnalyticsResolvedConfiguration extends IoTAnalyticsConfiguration {
