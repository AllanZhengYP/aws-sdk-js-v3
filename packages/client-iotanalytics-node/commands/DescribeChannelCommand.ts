...
export class DescribeChannelCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: DescribeChannel
        };

        return stack.resolve(
            handler<DescribeChannelInput, DescribeChannelOutput>(handlerExecutionContext),
