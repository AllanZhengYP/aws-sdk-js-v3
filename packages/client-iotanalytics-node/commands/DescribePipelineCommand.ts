...
export class DescribePipelineCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: DescribePipeline
        };

        return stack.resolve(
            handler<DescribePipelineInput, DescribePipelineOutput>(handlerExecutionContext),
