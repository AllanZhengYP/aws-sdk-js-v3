...
export class ListDatastoresCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
    ListDatastoresInput,
    OutputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: ListDatastores
        };

        return stack.resolve(
            handler<ListDatastoresInput, ListDatastoresOutput>(handlerExecutionContext),
