...
import {IoTAnalyticsConfiguration, IoTAnalyticsResolvedConfiguration, configurationProperties} from './IoTAnalyticsConfiguration';
import {InputTypesUnion} from './types/InputTypesUnion';
import {OutputTypesUnion} from './types/OutputTypesUnion';
import {clientVersion, ServiceMetadata} from './model/ServiceMetadata';

export class IoTAnalyticsClient {
    protected readonly config: IoTAnalyticsResolvedConfiguration;
    ...
    >(command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, IoTAnalyticsResolvedConfiguration, _stream.Readable>): Promise<OutputType>;
    send<
        InputType extends InputTypesUnion,
        OutputType extends OutputTypesUnion
    >(
        command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, IoTAnalyticsResolvedConfiguration, _stream.Readable>,
