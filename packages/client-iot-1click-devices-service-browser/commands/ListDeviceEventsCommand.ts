...
export class ListDeviceEventsCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: ListDeviceEvents
        };

        return stack.resolve(
            handler<ListDeviceEventsInput, ListDeviceEventsOutput>(handlerExecutionContext),
