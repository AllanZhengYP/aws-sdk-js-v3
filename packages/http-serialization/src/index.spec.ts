...
import {HttpRequest, HttpResponse} from '@aws-js-sdk-v3-prerelease/types';
...
Proxy-Authorization: basic aGVsbG86d29ybGQ=`;
        ...
        expect(() => parseRequest(serialized))
            .toThrowError('Invalid request string');
    });
...
Proxy-Authorization: basic aGVsbG86d29ybGQ=`;
        ...
        expect(() => parseRequest(serialized))
            .toThrowError('Invalid line encountered: headerValue');
    });

    it('should parse absolute URL targets', () => {
        expect(
            parseRequest('GET https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods/GET HTTP/1.1')
        ).toEqual({
            method: 'GET',
            protocol: 'https:',
...
describe('parseResponse', () => {
    ...
    it('should reject invalid messages', () => {
        ...
        expect(() => parseResponse(serialized))
            .toThrowError('Invalid response string');
    });
});
...
`
    ...
    it(
        'should serialize requests with a placeholder for ArrayBuffer bodies',
        () => {
            const request: HttpRequest<string> = {
                method: 'PUT',
                protocol: 'https:',
...
[binary payload]`
    ...
    it(
        'should serialize requests with a placeholder for ArrayBufferView bodies',
        () => {
            const request: HttpRequest<string> = {
                method: 'PUT',
                protocol: 'https:',
...
[binary payload]`
    ...
    it(
        'should serialize requests with a placeholder for stream bodies',
        () => {
            /**
...
`
    ...
    it(
        'should serialize responses with a placeholder for ArrayBuffer bodies',
        () => {
            const response: HttpResponse<string> = {
                headers: {
                    host: 'example.com',
...
[binary payload]`
    ...
    it(
        'should serialize responses with a placeholder for ArrayBufferView bodies',
        () => {
            const response: HttpResponse<string> = {
                headers: {
                    host: 'example.com',
...
[binary payload]`
    ...
    it(
        'should serialize responses with a placeholder for stream bodies',
        () => {
            /**
             * An environment specific stream.
             */
