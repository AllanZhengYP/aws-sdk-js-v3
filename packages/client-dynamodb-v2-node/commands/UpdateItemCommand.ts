...
export class UpdateItemCommand implements __aws_js_sdk_v3_prerelease_types.Command<
    InputTypesUnion,
    UpdateItemInput,
    OutputTypesUnion,
    UpdateItemOutput,
...
> {
    ...
    ): __aws_js_sdk_v3_prerelease_types.Handler<UpdateItemInput, UpdateItemOutput> {
