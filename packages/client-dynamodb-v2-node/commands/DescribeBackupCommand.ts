...
export class DescribeBackupCommand implements __aws_js_sdk_v3_prerelease_types.Command<
    InputTypesUnion,
    DescribeBackupInput,
    OutputTypesUnion,
...
> {
    ...
    ): __aws_js_sdk_v3_prerelease_types.Handler<DescribeBackupInput, DescribeBackupOutput> {
