...
export class DeleteTableCommand implements __aws_js_sdk_v3_prerelease_types.Command<
    InputTypesUnion,
    DeleteTableInput,
    OutputTypesUnion,
    DeleteTableOutput,
...
> {
    ...
    ): __aws_js_sdk_v3_prerelease_types.Handler<DeleteTableInput, DeleteTableOutput> {
