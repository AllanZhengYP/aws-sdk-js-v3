...
export class DescribeLimitsCommand implements __aws_js_sdk_v3_prerelease_types.Command<
    InputTypesUnion,
    DescribeLimitsInput,
    OutputTypesUnion,
...
> {
    ...
    ): __aws_js_sdk_v3_prerelease_types.Handler<DescribeLimitsInput, DescribeLimitsOutput> {
