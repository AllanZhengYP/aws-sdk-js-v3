...
jest.mock('@aws-js-sdk-v3-prerelease/util-base64-browser', () => {
    return {
        fromBase64: jest.fn(),
        toBase64: jest.fn(),
    };
...
} from '@aws-js-sdk-v3-prerelease/util-base64-browser';

jest.mock('@aws-js-sdk-v3-prerelease/util-base64-node', () => {
    return {
        fromBase64: jest.fn(),
        toBase64: jest.fn(),
    };
...
} from '@aws-js-sdk-v3-prerelease/util-base64-node';

jest.mock('@aws-js-sdk-v3-prerelease/is-node', () => {
