...
} from '@aws-js-sdk-v3-prerelease/client-cognito-identity-browser/commands/GetCredentialsForIdentityCommand';
import { Credentials, CredentialProvider } from '@aws-js-sdk-v3-prerelease/types';
