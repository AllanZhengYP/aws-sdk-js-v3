...
export class Transcribe extends TranscribeClient {
     ...
     */
    public createVocabulary(args: CreateVocabularyInput): Promise<CreateVocabularyOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public deleteTranscriptionJob(args: DeleteTranscriptionJobInput): Promise<DeleteTranscriptionJobOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public deleteVocabulary(args: DeleteVocabularyInput): Promise<DeleteVocabularyOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public getTranscriptionJob(args: GetTranscriptionJobInput): Promise<GetTranscriptionJobOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public listTranscriptionJobs(args: ListTranscriptionJobsInput): Promise<ListTranscriptionJobsOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public listVocabularies(args: ListVocabulariesInput): Promise<ListVocabulariesOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public startTranscriptionJob(args: StartTranscriptionJobInput): Promise<StartTranscriptionJobOutput>;
     ...
     *   - {Error} An error originating from the SDK or customizations rather than the service
     */
    public updateVocabulary(args: UpdateVocabularyInput): Promise<UpdateVocabularyOutput>;
