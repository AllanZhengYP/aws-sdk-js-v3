...
export class DeleteVocabularyCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: DeleteVocabulary
        };

        return stack.resolve(
            handler<DeleteVocabularyInput, DeleteVocabularyOutput>(handlerExecutionContext),
