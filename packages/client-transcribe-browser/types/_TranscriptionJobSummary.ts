...
export interface _TranscriptionJobSummary {
     ...
     */
    LanguageCode?: 'en-US'|'es-US'|'en-AU'|'fr-CA'|'en-GB'|'de-DE'|'pt-BR'|'fr-FR'|'it-IT'|'ko-KR'|string;
...
export interface _UnmarshalledTranscriptionJobSummary extends _TranscriptionJobSummary {
    /**
     * <p>A timestamp that shows when the job was created.</p>
     */
    CreationTime?: Date;
