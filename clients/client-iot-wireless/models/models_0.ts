...
export interface AssociateAwsAccountWithPartnerAccountRequest {
  ...
  /**
   * <p>The tags attached to the specified resource. Tags are metadata that can be used to manage a resource</p>
   */
  Tags?: Tag[];
}
...
export interface CreateDestinationRequest {
  ...
  /**
   * <p>The tags to attach to the new destination. Tags are metadata that can be used to manage a resource.</p>
   */
  Tags?: Tag[];
...
export interface CreateDeviceProfileRequest {
  ...
  /**
   * <p>The tags to attach to the new device profile Tags are metadata that can be used to manage a resource.</p>
   */
  Tags?: Tag[];
...
export interface CreateServiceProfileRequest {
  ...
  /**
   * <p>The tags to attach to the new service profile. Tags are metadata that can be used to manage a resource.</p>
   */
  Tags?: Tag[];
...
export interface CreateWirelessGatewayRequest {
  ...
  /**
   * <p>The tags to attach to the new wireless gateway. Tags are metadata that can be used to manage a resource.</p>
   */
  Tags?: Tag[];
