...
export class KinesisVideoArchivedMedia extends KinesisVideoArchivedMediaClient {
   ...
   */
  public getClip(args: GetClipCommandInput, options?: __HttpHandlerOptions): Promise<GetClipCommandOutput>;
  public getClip(args: GetClipCommandInput, cb: (err: any, data?: GetClipCommandOutput) => void): void;
  public getClip(
  ...
  public getClip(
    args: GetClipCommandInput,
    optionsOrCb?: __HttpHandlerOptions | ((err: any, data?: GetClipCommandOutput) => void),
    cb?: (err: any, data?: GetClipCommandOutput) => void
  ): Promise<GetClipCommandOutput> | void {
