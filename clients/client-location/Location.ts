...
export class Location extends LocationClient {
  ...
  /**
   * <p>Used in geofence monitoring. Evaluates device positions against the position of
   *             geofences in a given geofence collection.</p>
   */
  ...
  /**
   * <p>A batch request to retrieve device positions.</p>
   *          <note>
   *            <p>The response will return the device positions from the last 24 hours.</p>
   *          </note>
   */
  ...
  /**
   * <p>Uploads a position update for one or more devices to a tracker resource. The data is used for API queries requesting the device position and position history.</p>
   *          <note>
   *            <p>Limitation — Location data is sampled at a fixed rate of 1 position per
   *                30 second interval, and retained for 1 year before it is deleted.</p>
   *          </note>
   */
  ...
  /**
   * <p>Removes the association bewteen a tracker resource and a geofence collection.</p>
   *         <note>
  ...
  /**
   * <p>Retrieves the latest device position.</p>
   *          <note>
   *             <p>Limitation — Device positions are deleted after one year.</p>
   *          </note>
   */
  ...
  /**
   * <p>Stores a geofence to a given geofence collection, or updates the geometry of an
   *             existing geofence if a geofence ID is included in the request.</p>
   */
