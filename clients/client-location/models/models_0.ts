...
export interface DevicePositionUpdate {
  ...
  /**
   * <p>The timestamp for when the position update was received in <a href="https://www.iso.org/iso-8601-date-and-time-format.html">ISO 8601</a>
...
export interface DevicePosition {
  ...
  /**
   * <p>The timestamp for when the position was detected and sampled in <a href="https://www.iso.org/iso-8601-date-and-time-format.html"> ISO 8601</a>
   *             format: <code>YYYY-MM-DDThh:mm:ss.sssZ</code>. </p>
   */
  SampleTime: Date | undefined;

  /**
   * <p>The timestamp for when the tracker resource recieved the position in <a href="https://www.iso.org/iso-8601-date-and-time-format.html"> ISO 8601</a>
   *             format: <code>YYYY-MM-DDThh:mm:ss.sssZ</code>. </p>
   */
 ...
 *         <note>
 *             <p>Limitation — Amazon Location does not currently support polygons with holes,
...
export interface BatchUpdateDevicePositionError {
  ...
  /**
   * <p>The timestamp for when a position sample was attempted in <a href="https://www.iso.org/iso-8601-date-and-time-format.html"> ISO 8601</a>
   *             format: <code>YYYY-MM-DDThh:mm:ss.sssZ</code>. </p>
   */
  SampleTime: Date | undefined;
...
export interface CreateGeofenceCollectionRequest {
  ...
  /**
   * <p>Specifies the pricing plan for your geofence collection. There's three pricing plan
   *             options:</p>
   *         <ul>
   *             <li>
   *                <p>
   *                   <code>RequestBasedUsage</code> — Selects the "Request-Based Usage" pricing plan.</p>
   *             </li>
   *             <li>
   *                <p>
   *                   <code>MobileAssetTracking</code> — Selects the "Mobile Asset Tracking" pricing plan.</p>
   *             </li>
   *             <li>
   *                <p>
...
export interface CreateMapRequest {
   ...
   *         <ul>
   *             <li>
   *                <p>Must contain only alphanumeric characters (A–Z, a–z, 0–9), hyphens (-), and underscores (_). </p>
   *             </li>
   *             <li>
...
export interface CreatePlaceIndexRequest {
   ...
   *          <ul>
   *             <li>
   *                <p>Contain only alphanumeric characters (A-Z, a-z, 0-9) , hyphens (-) and underscores (_)
   *                ).</p>
   *             </li>
   *             <li>
  ...
  /**
   * <p>Specifies the pricing plan for your Place index resource. There's three pricing plan
   *          options:</p>
   *          <ul>
   *             <li>
   *                <p>
...
export interface CreateTrackerRequest {
   ...
   *          <ul>
   *             <li>
   *                <p>Contain only alphanumeric characters (A-Z, a-z, 0-9) , hyphens (-) and underscores (_).</p>
   *             </li>
   *             <li>
  ...
  /**
   * <p>Specifies the pricing plan for your tracker resource. There's three pricing plan
   *            options:</p>
   *          <ul>
   *             <li>
   *                <p>
...
export interface GetDevicePositionHistoryRequest {
   ...
   *          <ul>
   *             <li>
   *                <p>The given time for <code>EndTimeExclusive</code> must be after the time for
