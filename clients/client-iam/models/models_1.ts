...
export interface UpdateAccessKeyRequest {
   ...
   *          the key can be used for programmatic calls to AWS, while <code>Inactive</code> means that the key
   *          cannot be used.</p>
   */
...
export interface UpdateSigningCertificateRequest {
   ...
   *          certificate can be used for programmatic calls to AWS <code>Inactive</code> means that the
